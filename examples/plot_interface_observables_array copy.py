...
# select one row
select = 0
pos_gridsss = [pos_gridsss[select]]
data_profilesss = [data_profilesss[select]]
x_labelss = [x_labelss[select]]
y_labelss = [y_labelss[select]]
x_limsss = [x_limsss[select]]
y_limsss = [y_limsss[select]]
