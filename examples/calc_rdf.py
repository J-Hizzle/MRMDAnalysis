...
# %%
path_data = plb.Path('/srv/public/julianhille/project/mrmd/build/mrmd/io').resolve()
file_top = path_data / 'testH5MD.gro'
file_trj = path_data / 'dummy.h5md'
format_top = 'GRO'
format_trj = 'H5MD'
...
# %%
#with mda.Writer("sometest.h5md", n_atoms = universe.trajectory.n_atoms) as W:
#    W.write(universe)
## %%
#universeNew = mda.Universe(file_top, "sometest.h5md", topology_format=format_top, format=format_trj, convert_units=False)
## %%
