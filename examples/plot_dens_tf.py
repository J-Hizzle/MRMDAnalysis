...
# %%
pos_x_grids_dens = [pos_x_grid_dens for i in range(len(dens_vals))]
pos_x_grids_tf = [pos_x_grid_tf for i in range(len(tf_vals))]
...
if file_plt_dens:
    if os.path.isfile(file_plt_dens):
        ...
        plot_profile_in_adress_box(pos_x_grids_dens, dens_vals_to_plot, r_ref, r_min, r_max, x_label, y_label_dens, data_labels_dens, fig_title_dens, colors, y_lims_dens, file_plt_dens, format_plt_dens)
else:
    plot_profile_in_adress_box(pos_x_grids_dens, dens_vals_to_plot, r_ref, r_min, r_max, x_label, y_label_dens, data_labels_dens, fig_title_dens, colors, y_lims_dens)
# %%
if file_plt_tf: 
    if os.path.isfile(file_plt_tf):
            print('tf file already exists! Aborting.')
    else:
        plot_profile_in_adress_box(pos_x_grids_tf, tf_vals_to_plot, r_ref, r_min, r_max, x_label, y_label_tf, data_labels_tf, fig_title_tf, colors, y_lims_tf, file_plt_tf, format_plt_tf)
else:
    plot_profile_in_adress_box(pos_x_grids_tf, tf_vals_to_plot, r_ref, r_min, r_max, x_label, y_label_tf, data_labels_tf, fig_title_tf, colors, y_lims_tf)
# %%
if file_plt_pot: 
    if os.path.isfile(file_plt_pot):
            print('pot file already exists! Aborting.')
    else:
        plot_profile_in_adress_box(pos_x_grids_tf, pot_vals_to_plot, r_ref, r_min, r_max, x_label, y_label_pot, data_labels_pot, fig_title_pot, colors, y_lims_pot, file_plt_pot, format_plt_pot)
else:
    plot_profile_in_adress_box(pos_x_grids_tf, pot_vals_to_plot, r_ref, r_min, r_max, x_label, y_label_pot, data_labels_pot, fig_title_pot, colors, y_lims_pot)
# %%
